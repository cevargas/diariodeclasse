...
$toastElement.remove();$toastElement=null;if($container.children().length===0){$container.remove();previousToast=undefined;}}})();});}(typeof define==='function'&&define.amd?define:function(deps,factory){if(typeof module!=='undefined'&&module.exports){module.exports=factory(require('jquery'));}else{window['toastr']=factory(window['jQuery']);}}));$(function(){$.ajaxSetup({beforeSend:function(xhr,settings){},error:function(xhr,textStatus,errorThrown){toastr.error(errorThrown,'Opss..Ocorreu algum problema.');}});$('#confirm-dialog').on('shown.bs.modal',function(e){e.preventDefault();var codigo=$(e.relatedTarget).data('id');var url=$(e.relatedTarget).data('url');$('#delete').attr('data-id',codigo);$('#delete').attr('data-url',url);});$('#delete').on('click',function(e){var id=$(this).attr('data-id');var url=$(this).attr('data-url');$.ajax({type:"POST",data:{codigo:id},url:url,dataType:"json",success:function(json){}});});});