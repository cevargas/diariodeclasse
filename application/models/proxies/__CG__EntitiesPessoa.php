...
class Pessoa extends \Entities\Pessoa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Pessoa' . "\0" . 'codigo', '' . "\0" . 'Entities\\Pessoa' . "\0" . 'nome', '' . "\0" . 'Entities\\Pessoa' . "\0" . 'ddd', '' . "\0" . 'Entities\\Pessoa' . "\0" . 'telefone', '' . "\0" . 'Entities\\Pessoa' . "\0" . 'endereco', '' . "\0" . 'Entities\\Pessoa' . "\0" . 'email', '' . "\0" . 'Entities\\Pessoa' . "\0" . 'tipo', '' . "\0" . 'Entities\\Pessoa' . "\0" . 'senha');
        }
